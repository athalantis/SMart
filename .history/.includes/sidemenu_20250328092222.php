...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <?php 
    include "init_session.php"; // Pastikan session dimulai dengan benar
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Jika User (bukan Admin), tampilkan "Pemesanan" dan "Produk" -->
        <?php if ($role !== 'admin') : ?>
        ...
        <!-- Jika Admin, tampilkan menu Admin Panel -->
        <?php if ($role === 'admin') : ?>
