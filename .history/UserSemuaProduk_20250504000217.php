...
<div style="padding-top: 100px;">
    <div class="container mt-5">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center" id="product-list">
            ...
            <!-- Initially, it will be populated by fetch_product.php -->
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        function fetchProducts() {
            ...
            $.ajax({
                url: 'fetch_product.php', // Call to fetch_product.php
                type: 'GET',
                data: {
                    search: search,
                ...
                success: function(response) {
                    // Replace the product list with the updated list from the response
